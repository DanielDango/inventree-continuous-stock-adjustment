# Continouous Stock Adjustment- Frontend Code

This directory contains the frontend code for the Continouous Stock Adjustment plugin.
...
This will compile the frontend into the `../continouous_stock_adjustment/static` directory (ready for distribution).
